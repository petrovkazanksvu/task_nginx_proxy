...
curl -kGi https://my-nginx_frontend_1 #accross frontend nginx
curl -kGI https://my-nginx_backend_1:443 #straight to backend nginx
#the same output for client

docker logs -n 3 my-nginx_backend_1 
